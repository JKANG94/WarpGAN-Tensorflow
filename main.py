...
def parse_args():
    ...
    parser.add_argument('--selected_attrs', type=str, nargs='+', help='selected attributes for the CelebA dataset',
                        default=['Smiling', 'Big_Nose', 'Arched_Eyebrows', 'Narrow_Eyes', 'Pointy_Nose'])
...
def main():
    ...
    # open session
    X = np.linspace(0, args.img_size-1, args.img_size)
    Y = np.linspace(0, args.img_size-1, args.img_size)
